@echo off
REM Setup script untuk deployment Netlify (Windows)
REM Jalankan: setup-deploy.bat

echo 🚀 Setting up Portfolio Deployment...

REM Step 1: Install Netlify CLI jika belum ada
...
git init
git add .
git commit -m "feat: Initial portfolio setup with secure EmailJS integration - Complete portfolio website for Jefta Supraja - EmailJS contact form with fallback system - Responsive design with mobile optimization - Environment variables for secure credential management - Netlify deployment configuration - Security headers and CSP implementation"

REM Step 4: Setup remote repository
echo.
...
REM Step 5: Netlify setup instructions
echo.
